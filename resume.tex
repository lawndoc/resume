...
\begin{itemize}
    ...
    \item Placed on IT architecture team with the most senior IT members
    \item Automated git repo compliance using GitHub API
    \item Remediated hundreds of leaked secrets and vulnerabilities
    \item Built out CI/CD pipelines for many use cases including detection engineering, GitOps, and DevSecOps
    ...
    \item Pentested embedded PCs in Vermeer's industrial machinery
